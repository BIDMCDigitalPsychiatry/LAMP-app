...
function loadingValues(displayNumb, isBack) {
	...
	try {
		...
		if (arraySubmitedAnswers[currentQuestion - displayNumb] == null) {
			...
			//Add Top View here
			//allQuestionsArray[currentQuestion - displayNumb].surveyType
		...
		if ((allQuestionsArray[currentQuestion - displayNumb].surveyType == 2 || allQuestionsArray[currentQuestion - displayNumb].surveyType == 4 || allQuestionsArray[currentQuestion - displayNumb].surveyType == 5 || allQuestionsArray[currentQuestion - displayNumb].surveyType == 6 || allQuestionsArray[currentQuestion - displayNumb].surveyType == 7)) {
			Ti.API.info('Visible doneButtonOuterView');
			$.QuestionContentTopView.height = "43%";
			$.QuestionContentBottomView.height = "43%";
			$.doneButtonOuterView.height = "14%";
		} else {
			Ti.API.info('Hide doneButtonOuterView');
		...
		if (displayNumb == 2) {
			...
			if ($.doneButtonOuterView.height != "14%") {
				if (allQuestionsArray[currentQuestion - 1].surveyType == 2 || allQuestionsArray[currentQuestion - 1].surveyType == 4 || allQuestionsArray[currentQuestion - 1].surveyType == 5 || allQuestionsArray[currentQuestion - 1].surveyType == 6 || allQuestionsArray[currentQuestion - 1].surveyType == 7) {
					$.QuestionContentTopView.height = "43%";
					$.QuestionContentBottomView.height = "43%";
					$.doneButtonOuterView.height = "14%";
				} else {
...
/**
 * Function to set linkert answer
 */
...
/**
 * Function to set time picker answer
 */
...
/**
 * linkertAnswerClickBottom event handler
 */
...
/**
 * YesOrNoAnswerClickBottom handler
 */
...
/**
 * pickerControlTopChange handler
 */
...
/**
 * pickerControlTopChangeAndroid handler
 */
...
/**
 * pickerControlBottomChange handler
 */
...
function getSurveyValues() {
	...
	Ti.API.info('surveyDataArray ********* is', surveyDataArray);
