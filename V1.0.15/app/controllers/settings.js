...
function setLabel() {
	...
	if (settingsInfo.sympSurveySlotID == 0) {
		settingsInfo.sympSurveySlotID = 1;
	}
	if (settingsInfo.sympSurveyRepeatID == 0) {
		settingsInfo.sympSurveyRepeatID = 1;
	}
	if (settingsInfo.cognTestSlotID == 0) {
		settingsInfo.cognTestSlotID = 1;
	}
	if (settingsInfo.cognTestRepeatID == 0) {
		settingsInfo.cognTestRepeatID = 1;
	}
...
function onLogoutClick(e) {
	try {
		...
		commonFunctions.showConfirmation(commonFunctions.L('sureSignout', LangCode), [commonFunctions.L('no', LangCode), commonFunctions.L('yes', LangCode)], function() {
			...
			Alloy.Globals.NAVIGATION_CONTROLLER.closeWindowWithoutanimation('home');
			Alloy.Globals.NAVIGATION_CONTROLLER.closeWindowWithoutanimation('settings');
