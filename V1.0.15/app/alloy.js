...
Alloy.Globals.APP_NAME = "mindLAMP";
...
if (!OS_IOS) {
	...
	Alloy.Globals.DPIFactor = (dpi / 160);
	Alloy.Globals.DEVICE_WIDTH = Alloy.Globals.DEVICE_WIDTH / Alloy.Globals.DPIFactor;
	Alloy.Globals.DEVICE_HEIGHT_DPI = Alloy.Globals.DEVICE_HEIGHT / Alloy.Globals.DPIFactor;
	Alloy.Globals.DEVICE_HEIGHT = Alloy.Globals.DEVICE_HEIGHT / Alloy.Globals.DPIFactor;
	Alloy.Globals.IsTablet = diagonalSize > 6;

	if (Alloy.Globals.IsTablet) {
		if (diagonalSize < 8) {
			Alloy.Globals.IsMiniTablet = true;
		}
	}
...
//Production Server
Alloy.Globals.SERVICEURL ='https://portal.lamp.digital/LampAPI/api/';

//Google api key
Alloy.Globals.GOOGLEKEY ="" ;
...
Ti.App.Properties.setString('isFirstTimeLogin', "false");
Ti.App.Properties.setString('SleepValue', "");
Ti.App.Properties.setString('StepValue', "");
...
if (Ti.App.Properties.hasProperty("isInstructionShown") == false) {
	Ti.App.Properties.setString('isInstructionShown', "false");
}
if (Ti.App.Properties.hasProperty("isAgreeClick") == false) {
	Ti.App.Properties.setString('isAgreeClick', "false");
}
...
Alloy.Globals.LargeFontLight14 = {
	fontSize : '14sp',
	fontFamily : 'Aileron-Light'
};
...
Alloy.Globals.homehealthUltraFontLarge = {
	fontSize : '29sp',
	fontFamily : 'Aileron-UltraLight'
};
//ultra Light 15
...
Alloy.Globals.setCredentials = function(userName, password, userId, isGuest) {
	...
	var toggleMemoryGames = {
		gameArray : []
	};
	Ti.App.Properties.setObject('toggleCognitionGames', toggleMemoryGames);

	var toggleMindGames = {
		gameArray : []
	};
	Ti.App.Properties.setObject('toggleCognitionMindGames', toggleMindGames);
...
if (Ti.App.Properties.hasProperty("toggleCognitionGames") == false) {
	var toggleMemoryGames = {
		gameArray : []
	};
	Ti.App.Properties.setObject('toggleCognitionGames', toggleMemoryGames);
...
if (Ti.App.Properties.hasProperty("toggleCognitionMindGames") == false) {
	var toggleMindGames = {
		gameArray : []
	};
	Ti.App.Properties.setObject('toggleCognitionMindGames', toggleMindGames);
