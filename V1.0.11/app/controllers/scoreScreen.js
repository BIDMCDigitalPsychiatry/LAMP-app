...
function onGetGraphDetailsSuccess(e) {
	...
	Ti.API.info('***GRAPH DETAILS RESPONSE****  ', JSON.stringify(response));
	...
	Ti.API.info('dayArray array is', dayArray);
	...
	Ti.API.info('scoreArray is', scoreArray);
	...
	Ti.API.info('largest is', largest);
